...
# second step of the EYFN tutorial. It joins the org8 peers to the
# channel previously setup in the BYFN tutorial and install the
# chaincode as version 2.0 on peer0.org8.
#
...
successln "Org8 peer successfully added to network"
