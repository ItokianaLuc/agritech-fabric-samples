...
# second step of the EYFN tutorial. It joins the org7 peers to the
# channel previously setup in the BYFN tutorial and install the
# chaincode as version 2.0 on peer0.org7.
#
...
successln "Org7 peer successfully added to network"
