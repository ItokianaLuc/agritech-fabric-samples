...
COMPOSE_FILE_COUCH_ORG3=compose/${CONTAINER_CLI}/docker-compose-couch-org5.yaml
# use this as the default docker-compose yaml definition
COMPOSE_FILE_BASE=compose/compose-org5.yaml
COMPOSE_FILE_ORG3=compose/${CONTAINER_CLI}/docker-compose-org5.yaml
# certificate authorities compose file
COMPOSE_FILE_CA_BASE=compose/compose-ca-org5.yaml
COMPOSE_FILE_CA_ORG3=compose/${CONTAINER_CLI}/docker-compose-ca-org5.yaml
# database
DATABASE="leveldb"
