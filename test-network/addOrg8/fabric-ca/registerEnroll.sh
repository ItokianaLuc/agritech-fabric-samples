...
function createOrg8 {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:11054 --caname ca-org8 --tls.certfiles "${PWD}/fabric-ca/org8/tls-cert.pem"
  { set +x; } 2>/dev/null

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-11054-ca-org8.pem
  ...
  set -x
	fabric-ca-client register --caname ca-org8 --id.name peer0 --id.secret peer0pw --id.type peer --tls.certfiles "${PWD}/fabric-ca/org8/tls-cert.pem"
  { set +x; } 2>/dev/null

  infoln "Registering user"
  set -x
  fabric-ca-client register --caname ca-org8 --id.name user1 --id.secret user1pw --id.type client --tls.certfiles "${PWD}/fabric-ca/org8/tls-cert.pem"
  { set +x; } 2>/dev/null

  infoln "Registering the org admin"
  set -x
  fabric-ca-client register --caname ca-org8 --id.name org8admin --id.secret org8adminpw --id.type admin --tls.certfiles "${PWD}/fabric-ca/org8/tls-cert.pem"
  { set +x; } 2>/dev/null

  infoln "Generating the peer0 msp"
  set -x
	fabric-ca-client enroll -u https://peer0:peer0pw@localhost:11054 --caname ca-org8 -M "${PWD}/../organizations/peerOrganizations/org8.example.com/peers/peer0.org8.example.com/msp" --csr.hosts peer0.org8.example.com --tls.certfiles "${PWD}/fabric-ca/org8/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:11054 --caname ca-org8 -M "${PWD}/../organizations/peerOrganizations/org8.example.com/peers/peer0.org8.example.com/tls" --enrollment.profile tls --csr.hosts peer0.org8.example.com --csr.hosts localhost --tls.certfiles "${PWD}/fabric-ca/org8/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
	fabric-ca-client enroll -u https://user1:user1pw@localhost:11054 --caname ca-org8 -M "${PWD}/../organizations/peerOrganizations/org8.example.com/users/User1@org8.example.com/msp" --tls.certfiles "${PWD}/fabric-ca/org8/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
	fabric-ca-client enroll -u https://org8admin:org8adminpw@localhost:11054 --caname ca-org8 -M "${PWD}/../organizations/peerOrganizations/org8.example.com/users/Admin@org8.example.com/msp" --tls.certfiles "${PWD}/fabric-ca/org8/tls-cert.pem"
  { set +x; } 2>/dev/null
