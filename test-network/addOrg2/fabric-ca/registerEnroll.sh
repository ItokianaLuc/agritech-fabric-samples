...
function createOrg2 {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:11054 --caname ca-org2 --tls.certfiles "${PWD}/fabric-ca/org2/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
	fabric-ca-client enroll -u https://peer0:peer0pw@localhost:11054 --caname ca-org2 -M "${PWD}/../organizations/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/msp" --csr.hosts peer0.org2.example.com --tls.certfiles "${PWD}/fabric-ca/org2/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:11054 --caname ca-org2 -M "${PWD}/../organizations/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls" --enrollment.profile tls --csr.hosts peer0.org2.example.com --csr.hosts localhost --tls.certfiles "${PWD}/fabric-ca/org2/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
	fabric-ca-client enroll -u https://user1:user1pw@localhost:11054 --caname ca-org2 -M "${PWD}/../organizations/peerOrganizations/org2.example.com/users/User1@org2.example.com/msp" --tls.certfiles "${PWD}/fabric-ca/org2/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
	fabric-ca-client enroll -u https://org2admin:org2adminpw@localhost:11054 --caname ca-org2 -M "${PWD}/../organizations/peerOrganizations/org2.example.com/users/Admin@org2.example.com/msp" --tls.certfiles "${PWD}/fabric-ca/org2/tls-cert.pem"
  { set +x; } 2>/dev/null
